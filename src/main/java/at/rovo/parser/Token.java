...
public abstract class Token
{
    ...
    protected int no = 0;
    /**
     * The node's name, f.e. the element node's name is the HTML tag name in the page
     **/
    ...
    /**
     * The matrix to store the matching path flags such as "UP", "LEFT" and "UP_LEFT" between the node's children and
     * the matchedNode's children
     **/
    protected int[][] matchedMatrix = null;
    /**
     * The set of nodes in the other DOM tree which have compared with the current node during the two DOM trees
     * matching
     **/
    protected LinkedList<Token> comparedNodes = new LinkedList<>();
    /**
     * The set of matching path flag matrixes between the node's children and comparedNode's children
     **/
    ...
    public int getEndNo()
    {
        return this.parentEndNo;
    }

    public void setEndNo(int parentEndNo)
    {
    ...
    public void setSibNo(int sibNo)
    {
        this.sibNo = sibNo;
    }
    ...
    public Token getMatchedNode()
    {
        return this.matchedNode;
    }

    public void setMatchedNode(Token matchedNode)
    {
        this.matchedNode = matchedNode;
    }

    public int[][] getMatchedMatrix()
    {
        return this.matchedMatrix;
    }

    public void setMatchedMatrix(int m[][])
    {
        this.matchedMatrix = m;
    }

    public LinkedList<int[][]> getComparedMatrix()
    {
        return this.comparedMatrixes;
    }

    public void addComparedMatrices(int[][] matrix)
    {
        this.comparedMatrixes.add(matrix);
    }

    public LinkedList<Token> getComparedNodes()
    {
    ...
    public void setComparedNodes(LinkedList<Token> comparedNodes)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        return this.no == node.no
               && this.name.equalsIgnoreCase(node.name)
               && !((this.text == null && node.text != null)
                 || (this.text != null && node.text == null)
                 || (this.text != null && !this.text.equalsIgnoreCase(node.text)))
               &&this.level == node.level
               && this.parentNo == node.parentNo
               && this.sibNo == node.sibNo
