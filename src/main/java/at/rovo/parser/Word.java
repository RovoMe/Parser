...
/**
 * <p>
 * Represents a typical CDATA part in HTML or XML. This means text between two
 * tags, f.e.: in the following code-snippet 'Example' is the CDATA part of this
 * code: <code>&lt;p>Example&lt;/p></code>
 * </p>
 * 
